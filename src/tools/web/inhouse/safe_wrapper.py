...
class SafeCrawlerWrapper:
    ...
    def __init__(
        ...
        self._host_breakers: OrderedDict[str, CircuitBreaker] = OrderedDict()
    ...
    def _get_or_create_host_breaker_locked(self, netloc: str) -> CircuitBreaker:
    ...
    async def _classify_output(
        self,
        output,
        host_breaker: Optional[CircuitBreaker],
        netloc: str,
    ) -> CrawlResult:
