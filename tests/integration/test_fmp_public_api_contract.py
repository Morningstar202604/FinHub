...
class TestFundamentalsMcpContract:
    async def test_get_financial_statements_income(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_financial_statements
    ...
    async def test_get_financial_ratios(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_financial_ratios
    ...
    async def test_get_growth_metrics(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_growth_metrics
    ...
    async def test_get_historical_valuation(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_historical_valuation
    ...
    async def test_get_insider_trades(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_insider_trades
    ...
    async def test_get_dividends_and_splits(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_dividends_and_splits
    ...
    async def test_get_shares_float(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_shares_float
    ...
    async def test_get_key_executives(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_key_executives
    ...
    async def test_get_technical_indicator_rsi(self):
        from plugins.finhub_market_data.fundamentals_mcp_server import get_technical_indicator
...
class TestMacroMcpContract:
    async def test_economic_indicator_gdp(self):
        from plugins.finhub_market_data.macro_mcp_server import get_economic_indicator
    ...
    async def test_treasury_rates(self):
        from plugins.finhub_market_data.macro_mcp_server import get_treasury_rates
    ...
    async def test_earnings_calendar(self):
        from plugins.finhub_market_data.macro_mcp_server import get_earnings_calendar
...
class TestPriceDataMcpContract:
    """Cover FMP-fallback paths. finhub-data is preferred when available;
    these tests pin the FMP-side contract.
    """

    async def test_get_stock_data_daily(self):
        from plugins.finhub_market_data.price_data_mcp_server import get_stock_data
    ...
    async def test_get_asset_data_commodity(self):
        from plugins.finhub_market_data.price_data_mcp_server import get_asset_data
