"""Error-sanitization guard for the sandbox-side finhub-data client.

``FinHubMCPClient.fetch_short_data`` runs inside a Daytona sandbox and returns
...
from src.data_client.finhub_data.mcp_client import FinHubMCPClient
