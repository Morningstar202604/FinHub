"""Snapshot normalization for the finhub-data source.
...
from src.data_client.finhub_data.data_source import FinHubDataSource
...
def test_normalize_snapshot_maps_exact_session_fields():
    row = FinHubDataSource._normalize_snapshot(_raw_snapshot())
...
def test_normalize_snapshot_tolerates_missing_session_fields():
    ...
    row = FinHubDataSource._normalize_snapshot(raw)
