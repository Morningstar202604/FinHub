...
_MOD = "plugins.finhub_market_data.macro_mcp_server"
...
class TestGetEconomicCalendar:
    @pytest.mark.asyncio
    async def test_success(self):
        from plugins.finhub_market_data.macro_mcp_server import get_economic_calendar
...
class TestGetMarketRiskPremium:
    @pytest.mark.asyncio
    async def test_success(self):
        from plugins.finhub_market_data.macro_mcp_server import get_market_risk_premium
